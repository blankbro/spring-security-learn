package io.github.blankbro.authorizationserversocial;
...
public class AuthorizationServerSocialApplication {

    public static void main(String[] args) {
        ConfigurableApplicationContext applicationContext = SpringApplication.run(AuthorizationServerSocialApplication.class, args);
        log.info("=========>>> successful <<<=========");
        log.info("=========>>> successful <<<=========");
