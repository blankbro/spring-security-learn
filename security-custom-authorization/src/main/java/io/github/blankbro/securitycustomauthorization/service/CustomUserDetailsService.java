package io.github.blankbro.securitycustomauthorization.service;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import io.github.blankbro.securitycustomauthorization.entity.UserEntity;
import io.github.blankbro.securitycustomauthorization.mapper.UserMapper;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // List<GrantedAuthority> grantedAuthorities = AuthorityUtils.commaSeparatedStringToAuthorityList("ROLE_" + username);
